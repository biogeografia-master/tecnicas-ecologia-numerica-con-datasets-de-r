...
1. Un **manuscrito científico reproducible** (RMarkdown, ejecutable de inicio a fin), y
2. Una **presentación oral** (diapositivas, 17 min + 3 min de preguntas).
...
* Explora el dataset (ayúdate con `?dataset` / `help(dataset)` y documentación del paquete).
...
* Investiga (con apoyo de IA si quieres) pero **verifica**:
  ...
  * origen del dataset, muestreo y variables (`?dune`, `?varespec`, etc.),
